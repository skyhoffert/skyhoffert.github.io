...
level2:{
    ...
    terrain: [
        ...
        ["r",10650,-380,200,20,false],
        ["rr",11100,-550,200,20,-pi/16,false,false],
        ["r",10800,-820,20,100,false],
        ["rr",11100,-880,150,20,pi/16,false,false],
        ["r",11600,-980,250,20,false],
        ["bb",12000,-1000,60,0.015,{x:12000,y:-1300},{x:12000,y:-900},1],
        ["r",12250,-350,200,1000,false],
        
        ["r",13000,-500,820,20,true],
        ["r",12600,-390,20,200,true],
        ["r",12800,-390,20,200,true],
        ["r",13400,-800,20,580,true],
        ["otb",12740,-370,50,50,0,2],
        ["r",13050,-200,100,20,false],
        ["r",13400,-50,200,500,false],
        ["otb",14002,-180,1000,20,0,0.8],
        ["otb",13442,-555,60,20,0,2],
        ["r",13442,-700,60,60,false],
        ["r",13442,-950,60,60,false],
        
        ["r",14500,-600,300,200,false],
        ["r",15000,-800,300,200,false],
        ["r",15500,-600,300,200,false],
        ["r",16000,-400,300,200,false],
        
        ["r",16400,-150,100,600,false], // exit well
        ["r",16600,-150,100,600,false], // exit well
        ["bb",16400,-450,80,0.015],
        ["bb",16600,-450,80,-0.015],
    ],
    background: [
    ],
    foreground: [
    ...
    enemies: [
        ...
        ["s",15000,-900,0.1],
        ["s",15000,-900,-0.1],
        ["d",14800,15200,-1000,-910,0.15,400,800],
        ["s",15500,-700,0.08],
        ["s",15500,-700,-0.08],
        ["d",15300,15700,-800,-710,0.2,200,600],
        ["s",16000,-500,0.12],
        ["s",16000,-500,-0.12],
        ["d",15800,16200,-600,-510,0.1,500,500],
    ],
    ...
    levelEnd: {x:16500,y:-300,w:100,h:100},
